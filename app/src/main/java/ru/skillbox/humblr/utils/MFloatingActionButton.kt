...
class MFloatingActionButton:FloatingActionButton,OnClickListener {
    ...
    constructor(context: Context,attrs:AttributeSet):super(context, attrs){
        ...
        onRelease=array.getColor(R.styleable.MFloatingActionButton_tint_on_release,resources.getColor(R.color.grey2,null))
        onSelected=array.getColor(R.styleable.MFloatingActionButton_tint_on_selected,resources.getColor(R.color.grey2,null))
        array.recycle()
    }
