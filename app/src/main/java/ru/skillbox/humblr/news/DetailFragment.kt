...
@AndroidEntryPoint
class DetailFragment : Fragment(), CommentAdapter.CommentHandler {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pagerAdapter = DetailPagerAdapter { url, imageView ->
            val uri = url.replace("amp;", "")
            Glide.with(imageView).load(uri).skipMemoryCache(true).into(imageView)
                .onLoadFailed(AppCompatResources.getDrawable(imageView.context, R.drawable.oops))
        }
