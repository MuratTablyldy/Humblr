...
@HiltViewModel
class WindowFragViewModel @Inject constructor(val repository: MainRepository) : ViewModel() {
    ...
    val linkG = MutableLiveData<Link.LinkRedditVideo>(null)
        ...
        viewModelScope.launch {
            ...
            when (value) {
                is Result.Success -> {
                    ...
                    val linkq = array[0].data.children?.first()?.data as Link.LinkRedditVideo
                    linkG.postValue(linkq)
